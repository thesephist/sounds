export const SOUNDS_LIST = {
    ...
    'greyhouse': {
        name: 'Greyhouse Coffee',
        description: 'It seems like every college campus has a couple of coffee shops that become study and social hubs for students, and Greyhouse is that cafe for the Purdue University campus. Growing up in the city, I\'ve visited Greyhouse for coffee and meetings countless times. When it first opened, Greyhouse used to also host weekly meetups of local entrepreneurs and founders. Though the tradition has since moved elsewhere, I like to think the spirit lives on.',
    ...
    'poipu-beach': {
        ...
        description: 'In spring 2021, I took a trip to Hawaii for a working trip/retreat with the rest of my team. For the first week, we stayed near this shallow, peaceful beach in Poipu, learning to surf and enjoying the sun. This clip was recorded one morning when I woke up just in time to watch the sun rise and spill its warmth over the tropical waters.',
        date: new Date('2021-04-07'),
        lat: 21.874593,
        lng: -159.457494,
    },
    'waipoo-falls-trail': {
        name: 'Waipoo Falls Trail',
        description: 'I honestly don\'t recall too much about this particular hiking expedition, except that I think we kayaked up a river to find ourselves on the hiking trail leading up to the falls. It was a great short trip into Hawaii\'s island-climate forest.',
        date: new Date('2021-04-08'),
        lat: 22.108988,
        lng: -159.663582,
    },
    'brenneckes-beach-bar': {
        name: 'Brennecke\'s Beach Bar',
        description: 'A classic American beach bar, complete with Hawaiian vibes, world-famous cocktails, and live music.',
        date: new Date('2021-04-09'),
        lat: 21.873861666290534,
        lng: -159.45352835274844,
    },
    'sunset-beach': {
        name: 'Sunset Beach, Oahu',
        description: 'Probably my favorite beach during my first trip to Hawaii.',
        date: new Date('2021-04-14'),
        lat: 21.674794255221116,
        lng: -158.03999019911308,
    },
    'guggenheim': {
        name: 'Guggenheim Museum',
        description: 'When I visited the Guggenheim to record this clip, the museum was still recovering from the COVID-19 pandemic -- the famous rotunda was emptier than usual. But that made the museum\'s architecture even more interesting to take in as we walked up the spiral walkway that circumscribes the building.',
        date: new Date('2021-05-08'),
        lat: 40.782961468414065,
        lng: -73.95906944620747,
    },
    'mission-dolores-park': {
        name: 'Mission Dolores Park',
        description: 'Dolores Park is, in my experience, one of the best of the trademark parks scattered across San Francisco\'s residentail hills. It features a spectacular view of the downtown area, as well as lots of picnic space. I captured this particular clip when I visited the park for a startup-themed meetup in the city.',
        date: new Date('2021-05-15'),
        lat: 37.75972771237975,
        lng: -122.42763528549705,
    },
    'manhattan-bridge': {
        name: 'Pebble Beach, DUMBO',
        description: 'New York City is filled with neighborhoods named after funny and convoluted acronyms, and DUMBO is no exception -- it stands for "Down Under the Manhattan Bridge Overpass". I recorded this clip while on a walk around the beautiful Brooklyn Bridge Park, from where you can see a great view of the lower Manhattan skyline.',
        date: new Date('2021-06-26'),
        lat: 40.704544128623425,
        lng: -73.9903327896291,
    },
};
